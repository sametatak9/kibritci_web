...
const guvenlikReplacements = [
  ...
  [
    `      <div className="bg-slate-955 border-b border-slate-855 p-2.5 px-6 flex justify-between items-center text-xs text-slate-305 shrink-0">`,
    `      {!isStandalone && (\n        <div className="bg-white border-b border-slate-200 p-2.5 px-6 flex justify-between items-center text-xs text-slate-700 shrink-0">`
  ],
  [
  ...
  [`w-full lg:w-72 bg-slate-955 border-b lg:border-b-0 lg:border-r border-slate-855 flex flex-col p-4 space-y-4 shrink-0 lg:overflow-y-auto`, `w-full lg:w-72 bg-white border-b lg:border-b-0 lg:border-r border-slate-200 flex flex-col p-4 space-y-4 shrink-0 lg:overflow-y-auto`],
  [`w-full lg:w-72 bg-slate-900 border-b lg:border-b-0 lg:border-r border-slate-800 flex flex-col p-4 space-y-4 shrink-0 lg:overflow-y-auto`, `w-full lg:w-72 bg-white border-b lg:border-b-0 lg:border-r border-slate-200 flex flex-col p-4 space-y-4 shrink-0 lg:overflow-y-auto`],
...
const kampciReplacements = [
  ...
  [
    ...
    `<span className="text-[10px] bg-slate-100 text-slate-655 px-2 py-0.5 rounded-md uppercase font-black">💻 Web Sürüm</span>`
  ],
