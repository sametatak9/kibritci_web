...
export function getCorporateReportCss(): string {
  return `
    ...
    .corporate-report-watermark-img{position:absolute;right:-2%;top:48%;transform:translateY(-50%);width:360px;max-width:38%;height:auto;opacity:1;pointer-events:none;z-index:0}
    .corporate-report-logo-img{height:110px;width:auto;max-width:450px;display:block;object-fit:contain;object-position:left center;margin-left:-10px}
    ...
    .corporate-report-footer{position:relative;z-index:2;margin-top:24px;padding-top:8px;flex-shrink:0}
    ...
    @media print{.corporate-report{min-height:0}.corporate-report-watermark-img{opacity:1;-webkit-print-color-adjust:exact;print-color-adjust:exact}.corporate-report-logo-img{-webkit-print-color-adjust:exact;print-color-adjust:exact}}
  `;
}
